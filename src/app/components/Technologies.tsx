        ...
        >
          ...
          {selectedCategory === Categories.MAIN ? (
            <div className="w-full grid grid-cols-3 gap-4">
              {technologies.main.map((technology, index) => {
                return <MainTechnology key={index} technology={technology} />;
              })}
            </div>
          ) : (
            <>
              ...
              <div className="w-full flex justify-center mt-4 text-center">
                <p className="text-[9px] italic text-slate-350 leading-normal">
                  Disclaimer: This list contains all the technologies that I
                  have worked with in the past. <br></br>
                  Not necessarily the technologies that I am most comfortable
                  with.
                </p>
              </div>
            </>
          ...
          <div
            className={`w-full flex justify-center items-center gap-4 ${
              selectedCategory === Categories.MAIN ? "mt-4" : ""
            } text-[10px]`}
          >
            {/* <button
